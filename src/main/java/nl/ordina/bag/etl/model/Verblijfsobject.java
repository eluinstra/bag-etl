...
public interface Verblijfsobject extends BAGAdresseerbaarObject
{
  String getVerblijfsobjectGeometrie();
  List<Gebruiksdoel> getGebruiksdoelenVerblijfsobject();
  int getOppervlakteVerblijfsobject();
  StatusVerblijfsobject getVerblijfsobjectStatus();
  List<Long> getGerelateerdPanden();
}
