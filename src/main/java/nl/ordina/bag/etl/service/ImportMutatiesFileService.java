...
public class ImportMutatiesFileService
{
	...
	public void execute(File mutatiesFile)
	{
		try
		{
			...
			if (levering == null)
			{
				logger.error("Leveringsdocument-BAG-Mutaties.xml not found!");
				return;
			}
		...
		{
			logger.info("Processing file " + mutatiesFile.getName() + " finished");
	...
	public static void main(String[] args) throws Exception
	{
		...
		ImportMutatiesFileService importMutatiesFile = new ImportMutatiesFileService();
