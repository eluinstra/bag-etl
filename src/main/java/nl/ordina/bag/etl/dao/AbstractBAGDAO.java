...
public abstract class AbstractBAGDAO implements BAGDAO
{
	...
	@Override
	public boolean existsWoonplaats(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsOpenbareRuimte(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsNummeraanduiding(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsPand(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsVerblijfsobject(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsLigplaats(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsStandplaats(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
	...
	@Override
	public boolean existsGerelateerdPand(long id) throws DAOException
	{
		try
		{
			return jdbcTemplate.queryForInt(
				"select count(bag_pand_id)" +
				" from bag_gerelateerd_pand" +
				" where bag_pand_id = ?",
				id
			) > 0;
		}
